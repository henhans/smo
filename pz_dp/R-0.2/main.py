...
def run_dmft(params, config_file_name=None):
    ...
    full_params = None
    default_config_name = os.path.join('/mnt/home/tlee1/git/ccq-software-build/triqs/3.3.x_nix2.3_llvm/installation/lib/python3.11/site-packages/solid_dmft/',#os.path.dirname(__file__),
